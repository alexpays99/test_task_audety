...
class UIConstants {
  static const String imageListScreenAppBarTitle = 'Unsplash images';
  static const int defaultListLength = 10;

  static const double photoInfoCardPadding = 8.0;
  static const double photoInfoCardBorderRadius = 20.0;
  static const double photoInfoCardHeight = 0.3;
  static const String photoInfoCardAuthorName = 'Unknown';
  static const String errorMessage =
      "Something went wrong while uploading from network!";
  static const double elementSmallPosition = 8.0;
  static const double elementMiddlePosition = 14.0;
  static const double elementLargePosition = 20.0;

  //Colors
  static const Color photoInfoCardTextColor = Color(0xffffffff);
